...
PARSER.add_argument('--no-render_mode', dest='render_mode', action='store_false')
...
PARSER.add('--rnn_restart_factor', required=True, type=float, help='factor of importance for restart=1 rare case for loss')
...
PARSER.add('--controller_env_name', type=str, default='CarRacing-v0', help='name of environment')
